...
Install curl on the lab ubuntu vm:
...
https://192.168.10.3/restconf/data/Cisco-IOS-XE-native:native/hostname
```
...
```json
{
  "Cisco-IOS-XE-native:hostname": "R3"
}
```
